...
add(
  ...
  def({
    ...
    interactions: [
      act({ id: 'use', label: 'Use the toilet', category: 'needs', icon: '🚽', durationMinutes: 4, effects: { needs: { bladder: 100, hygiene: -2 } }, satisfies: ['bladder'], autonomyWeight: 4, requiresState: { unoccupied: true, notBroken: true, maxDirty: 97 }, setsState: { occupied: true }, dirtiesBy: 2, wearBy: 0.1, group: 'Bathroom' }),
